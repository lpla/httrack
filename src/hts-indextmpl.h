...
#define HTS_INDEX_FOOTER \
  ...
  "	<BR>"LF\
  "  	<H6 ALIGN=\"RIGHT\">"LF\
  "	<I>Mirror and index made by HTTrack Website Copier [XR&amp;CO'2019]</I>"LF\
  "	</H6>"LF\
  "	%s"LF\
  ...
  "	<tr>"LF\
  "	<td id=\"footer\"><small>&copy; 2019 Xavier Roche & other contributors - Web Design: Kauler Leto.</small></td>"LF\
  "	</tr>"LF\
  "</table>"LF\
  ""LF\
  "</body>"LF\
